...
| [**4: Portfolio Object**](units/unit4) | 3 | Objects | Students will update thier portfolio about me page with create an object that contains information about themselves. Students will navigate the object and pull information to display to the screen.   |
...
| [**Midyear Review**](units/mid) | 1 | Review | Students will take a coding challenge that will test all the skills they have been taught so far.|
| [**6: Giphy  API**](units/unit6) | 3 | API, GET, AJAX  | Students will be introduced to APIs. They will create an application by which they use the Giphy API and display it to the results screen. They will iterate over the array and add an div containg thumbnails to the screen.|
| [**7: API**](units/unit7)| 3 | API | Students will be refine thier work with APIs. They will create an application by which they use the API and display it to the results screen.|
