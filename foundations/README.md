...
| [**9**](units/unit9)  JavaScript: Value Types, Operators, Variables, & Conditionals| In this unit students are introduced to **Value Types, Operators, Variables, and Conditional Statements** by making two games that ask the user to guess a certain word or number.|
